...
#ifndef CUDA_SIMD_INFO_H
#define CUDA_SIMD_INFO_H
...
struct sm_info_t {
   ...
   std::size_t gnu_dev_major;
	std::size_t gnu_dev_minor;
   std::size_t major;          // compute capability version
   std::size_t minor;          // compute capability version
